...
public class Application {
    ...
    // variabel untuk mainframe dan komponen UI
    ...
    // variabel untuk setor total Amount
    private double totalAmount = 0.0;
    
    // ArrayList untuk setor data panel values
    private ArrayList<String> dataPanelValues = new ArrayList<>();
    
    // variabel untuk form dragging
    ...
    public Application() {
        ...
        // Menghapus form border dan tombol default close dan minimize 
        ...
        // Membuat dan setup minimize label
    ...
    private String fixNegativeValueDisplay(double value){
        ...
        // Check if the input starts with "Rp.-" (indicating negative)
    ...
    private void removeSelectedTransaction(){
        ...
        if(selectedRow != -1){
            // Obtain the transaction details from the selected row //! message notif
    ...
    private void showAddTransactionDialog(){
        ...
        // Create a panel to hold the component in a grid layout
    ...
    private void addTransaction(JComboBox<String> typeComboBox, JTextField descriptionField, JTextField amountField){
            ...
            // Income
            if(type.equals("Income")){ totalAmount += newAmount; } // TODO
            // Expense
        ...
        JPanel dataPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g){
                ...
                if(title.equals("Total")){
                    ...
                    //drawDataPanel(g2d, title, String.format("Rp.%,.2f", totalAmount), getWidth(), getHeight());
